    ...
    <section className="relative pt-6 pb-16 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 max-w-2xl mx-auto">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-[10px] uppercase font-black tracking-wider text-purple-200">Step 2</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl mx-auto mt-10">
          ...
          <div 
            onClick={handleGoToPay}
            className="glass-card p-6 rounded-3xl border border-slate-200 dark:border-white/10 hover:border-amber-400/60 cursor-pointer transition-all hover:scale-[1.02] touch-press group space-y-3 bg-white dark:bg-slate-950"
          >
          ...
          <div 
            onClick={handleGoToVote}
            className="glass-card p-6 rounded-3xl border border-slate-200 dark:border-white/10 hover:border-purple-400/60 cursor-pointer transition-all hover:scale-[1.02] touch-press group space-y-3 bg-white dark:bg-slate-950"
          >
            <div className="flex items-center justify-between">
            ...
            <h3 className="text-base font-black text-slate-900 dark:text-white group-hover:text-purple-600 dark:group-hover:text-purple-300 transition-colors flex items-center gap-2">
              ...
              <span>Step 2: Vote Faculty & Stories</span>
            </h3>
            <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed font-medium">
